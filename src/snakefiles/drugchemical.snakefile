...
rule drugchemical_conflated_synonyms:
    ...
    run:
        synonymconflation.conflate_synonyms(synonym_files=[input.drugchemical_conflation], conflation_file=input.chemical_synonyms, output=output.drugchemical_conflated)
