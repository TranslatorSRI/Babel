...
rule anatomy_compendia:
    input:
        labels=expand("{dd}/{ap}/labels",dd=config['intermediate_directory'],ap=config['anatomy_prefixes']),
        synonyms=expand("{dd}/{ap}/synonyms",dd=config['intermediate_directory'],ap=config['anatomy_prefixes']),
