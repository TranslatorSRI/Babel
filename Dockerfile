...
ADD https://ftp.ncbi.nih.gov/gene/DATA/gene2ensembl.gz babel_downloads/NCBIGene/gene2ensembl.gz
ADD https://ftp.ncbi.nih.gov/gene/DATA/gene_info.gz babel_downloads/NCBIGene/gene_info.gz
ADD https://ftp.ncbi.nih.gov//gene/DATA/gene_orthologs.gz babel_downloads/NCBIGene/gene_orthologs.gz
ADD https://ftp.ncbi.nih.gov//gene/DATA/gene_refseq_uniprotkb_collab.gz babel_downloads/NCBIGene/gene_refseq_uniprotkb_collab.gz
ADD https://ftp.ncbi.nih.gov//gene/DATA/mim2gene_medgen babel_downloads/NCBIGene/mim2gene_medgen
